...
const PdfToPptx = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/convert_pdf_to_pptx', formData, {
        responseType: 'json',
      });
    ...
    <div className="container">
      <div className="flex-center">
        <div className="border-box">
          <h1 className="title">PDF To PPTX</h1>
          <p className="description">Convert your PDF To PPTX documents with incredible accuracy.</p>
