...
const PdfToWord = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/convert_pdf_to_docx', formData, {
        responseType: 'json',
      });
    ...
    <div className="container">
      <div className="flex-center">
        <div className="border-box">
          <h1 className="title">PDF to Word</h1>
          <p className="description">Convert your PDF to Word documents with incredible accuracy.</p>
