...
const PptxToPdf = () => {
  ...
  const handleFileChange=(e) =>{
    ...
    if (fileName) {
      ...
      if(extension == 'pptx'){
        ...
        setSelectedFile("");
        setDownloadError("Error Occured: You have not selected PPTX file");
      }
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/convert_pptx_to_pdf', formData, {
        responseType: 'json',
      });
    ...
    <div className="container">
      <div className="flex-center">
        <div className="border-box">
          <h1 className="title">PPTX To PDF</h1>
          <p className="description">Convert your PPTX To PDF documents with incredible accuracy.</p>
